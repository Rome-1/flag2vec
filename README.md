...
- **Phase 4** — Mars-terraformed flags. Earth flag tradition geography → Martian regional inheritance → procedurally generated Martian flags → embed sanity-check. *Shipped.*
